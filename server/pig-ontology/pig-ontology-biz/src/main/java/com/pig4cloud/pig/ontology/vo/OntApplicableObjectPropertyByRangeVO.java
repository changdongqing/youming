 ...
 */
@Data
@Schema(description = "适用对象属性（按值域）")
public class OntApplicableObjectPropertyByRangeVO {
	...
	@Schema(description = "命中的声明值域实体类型ID")
	private Long matchedRangeEntityTypeId;

	@Schema(description = "命中的声明值域实体类型名称")
	private String matchedRangeName;

	@Schema(description = "命中的声明值域实体类型中文标签")
	private String matchedRangeLabel;
