...
const ontologyDiagnostics = diagnosticLines.filter((line) =>
	/^src\/(views\/ontology\/entity-type|views\/ontology\/data-property|views\/ontology\/object-property|views\/ontology\/axiom-rule|views\/ontology\/instance|views\/ontology\/visualization|api\/ontology\/entity-type|api\/ontology\/data-property|api\/ontology\/object-property|api\/ontology\/axiom-rule|api\/ontology\/instance|api\/ontology\/visualization|types\/ontology)\//.test(line)
);
