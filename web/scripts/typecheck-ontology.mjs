...
const ontologyDiagnostics = diagnosticLines.filter((line) =>
	/^src\/(views\/ontology\/entity-type|views\/ontology\/data-property|views\/ontology\/object-property|api\/ontology\/entity-type|api\/ontology\/data-property|api\/ontology\/object-property|types\/ontology)\//.test(line)
);
